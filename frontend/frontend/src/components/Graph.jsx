...
function Graph({radius, points, trigger, updateTrigger, r_loc, updateR_loc}) {
...
// var r = document.getElementById("ch_r").value
    ...
    function drawRect(radius, context){
        const r = radius;
        context.strokeStyle='rgb(20, 50, 150, 0.7)';
        context.fillStyle='rgb(20, 50, 100, 0.4)';
        context.strokeRect(-r/2,r,r/2,-r);
        context.fillRect(-r/2,r,r/2,-r);
        // console.log("in rect")
    }
    function drawTriangle(radius, context){
        const r = radius;
        context.strokeStyle='rgb(20, 50, 150, 0.7)';
        context.fillStyle='rgb(20, 50, 100, 0.4)';
        context.beginPath();
    ...
    function drawQuart(radius, context){
        const r = radius;
        context.strokeStyle='rgb(20, 50, 150, 0.7)';
        context.fillStyle='rgb(20, 50, 100, 0.4)';
        context.beginPath();
    ...
    async function handleClick(e){
        if(radius<0){
            window.alert("choose a correct radius");
            return;
        }
